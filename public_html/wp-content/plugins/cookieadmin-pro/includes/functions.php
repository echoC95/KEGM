...
function cookieadmin_pro_expiry_notice(){
	...
	if(
		...
		echo '<div class="notice notice-error is-dismissible" id="cookieadmin-pro-expiry-notice">
				...
				sprintf(esc_html__('Your SoftWP license has %1$sexpired%2$s. Please renew it to continue receiving uninterrupted updates and support for %3$s.', 'cookieadmin-pro'),
...
function cookieadmin_pro_scan_cookies($urls){
	...
	wp_send_json_error(array('message' => __('Cookie Scan can be triggered once an hour', 'cookieadmin-pro')));
}